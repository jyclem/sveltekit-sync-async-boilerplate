...
<div class="input">
	<div>
		<input type="text" name="submit" required value={todo?.name || name} on:input={onInput} />
...
<style lang="scss">
	.input {
		...
		button {
			...
			&:not([disabled]):focus {
				box-shadow: 0 0 0.25rem rgba(0, 0, 0, 0.5), -0.125rem -0.125rem 1rem rgba(66, 66, 66, 0.5),
					0.125rem 0.125rem 1rem rgba(109, 108, 108, 0.5);
			}
